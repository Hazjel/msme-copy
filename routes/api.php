...
Route::prefix('v1')->group(function () {
    ...
    Route::get('barangs', [MasterDataApiController::class, 'barangs']);
    ...
    // Laporan (Kelompok 2)
    Route::get('dashboard', [LaporanApiController::class, 'dashboard']);
    Route::get('laporan/pembelian', [LaporanApiController::class, 'pembelian']);
    Route::get('laporan/retur-pembelian', [LaporanApiController::class, 'returPembelian']);
});
